...
#ifndef GAZEBO_PLUGINS__GAZEBO_ROS_MESH_DISTANCE_HPP_
#define GAZEBO_PLUGINS__GAZEBO_ROS_MESH_DISTANCE_HPP_
...
class GazeboRosModelDistance : public gazebo::ModelPlugin
{
public:
  /// Constructor
  GazeboRosModelDistance();

  /// Destructor
  virtual ~GazeboRosModelDistance();
...
private:
  ...
  /// data members.
  std::unique_ptr<GazeboRosModelDistancePrivate> impl_;
};
}  // namespace gazebo_plugins

#endif  // GAZEBO_PLUGINS__GAZEBO_ROS_MESH_DISTANCE_HPP_
